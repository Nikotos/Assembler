...
namespace oak
{
    ...
    const uint16_t DICT_SIZE = 1019;

    const uint8_t MAX_WORD_LEN = 40;

    const char* DEFAULT_DUMP_FILE = "dictionary_out.txt";
    ...
    int if_str_equ(const char* word1, const char* word2);
}
...
/*==============================================================================
 *
 *              class Node, almost List in this project
 *
 *                  @param1 - word
 *                  @param2 - frequency
 *
...
public:
    ...
    Node* old_fins(const char* word);

    Node* fins(const char* word);
